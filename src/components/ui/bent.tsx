    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={item.header}
          className={cn("[&>p:text-lg] bg-black border border-white", item.className)}
          icon={item.icon}
        />
      ))}
    </BentoGrid>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full h-6 rounded-full bg-neutral-900" />
      </motion.div>
      <motion.div
      ...
      >
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
        <div className="w-full  h-6 rounded-full bg-neutral-900"></div>
      </motion.div>
      <h1 className="text-white text-2xl font-semibold py-14">Here To Respond</h1>
    </motion.div>
  );
};
const SkeletonTwo = () => {
